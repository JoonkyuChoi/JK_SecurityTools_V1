## 단위 테스트 (Debug) : 4급 보안 자체검증 예제 어플 (selfer1_example.exe)
...
> Result:
  [INF] Injected a SCB in the target SCF.
        The SCB was injected at 20260314-105658 and can be used indefinitely.
----------------------------------------
Press any key. The current screen disappears.
...
> Result:
  [INF] Injected a SCB in the target SCF.
        The SCB was injected at 20260314-104843 and can be used 1 more times.
----------------------------------------
Press any key. The current screen disappears.
